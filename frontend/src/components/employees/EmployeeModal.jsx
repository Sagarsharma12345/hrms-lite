      ...
      <div className="relative bg-white w-full max-w-2xl rounded shadow-2xl overflow-hidden border border-slate-300 animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="bg-[#232F3E] px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="p-1.5 bg-[#FF9900] rounded-sm">
        ...
        <form onSubmit={handleSubmit} className="divide-y divide-slate-100">
          ...
          <div className="bg-slate-50 px-8 py-4 flex justify-end gap-3">
            <button
              type="button"
              onClick={onClose}
              className="px-5 py-2 text-[11px] font-black text-slate-500"
            >
              Cancel
            </button>
            ...
            <button
              disabled={loading}
              type="submit"
              className="bg-[#FF9900] text-[#232F3E] font-black text-[11px] px-8 py-2 rounded-sm shadow-md flex items-center gap-2 uppercase"
            >
              {loading ? (
